...
@Entity
@Table(name = "pisosNuevos")
@Data
@AllArgsConstructor
@NoArgsConstructor
public class PisoNuevoEntity {
    ...
    @OneToMany(mappedBy = "pisoNuevo", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<VisitaPisoNuevoEntity> visitas;
}
